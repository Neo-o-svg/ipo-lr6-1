while True:  # Начинаем бесконечный цикл, который будет выполняться, пока не будет получен корректный ввод.
    ...
    elif not num.isdigit():  # Проверяем, является ли введенное значение числом.
...
if allow:  # Условие выполнится только если allow == True, т.е. ввод был корректным.
    ...
    print(f"Количество различных слов в тексте: {len(words_set)}")  # Выводим количество различных слов в тексте, используя длину набора words_set. 
